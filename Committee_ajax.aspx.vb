...
Partial Class AdminConfig_Committee_ajax
    ...
    Sub LoadEmpDataForEdit(ByVal EventId As Integer, ByVal RowNum As Integer)
        Dim dt As New DataTable
        Dim result As String = ""
    ...
    Sub LoadBranchDataForEdit(ByVal EventId As Integer, ByVal RowNum As Integer)
        Dim dt As New DataTable
        Dim result As String = ""
    ...
    Public Shared Function getCommitteeMemberByEventIdAndRowNum(ByVal eventId As Integer, ByVal rowNum As Integer) As DataTable
        Dim dt As New DataTable
        Dim da As New OracleDataAdapter
        Dim con As New OracleConnection
        Dim cmd As New OracleCommand
    ...
    Public Shared Function AddCommittee(ByVal vEventId As Integer, ByVal vMemberTypeId As Integer,
    ...
    Public Shared Function DeleteRow(ByVal vEventId As Integer, ByVal vRowNum As Integer) As Boolean
